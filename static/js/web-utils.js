...
function sentParamter(site,pageC,AID,TYPE,parm1,parm2,parm3){
	...
	if(isSended == '-1'){
		document.write("<img src='https://counter.yesky.com/counter.shtml?UV="
...
// 下载按钮计划发送请求
function sentPlan(RESID,TYPE,PLAN){
	document.write("<img src ='https://counter.yesky.com/btnshow.shtml?time="+ new Date().getTime()+"&cur="+ encodeURIComponent(document.URL)+"&resid="+ RESID +"&type="+ TYPE +"&plan="+ PLAN +"' border='0' alt='' width='0' height='0'>");
}
